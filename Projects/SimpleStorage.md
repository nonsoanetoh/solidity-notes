...
contract SimpleStorage{
    ...
    function docsPureFunction(string memory name) public pure returns (string memory) {
        return pureFunction(name);
    }

    function pureFunction(string memory name) private pure returns (string memory) {
