...
contract Overflow {
    ...
    function add() public {
        ...
        /** a potential application of this would be saving gas by avoiding the calculation entirely when you are
        confident that the value wont pass the upper or lower limits of the data type **/
    }
}
```
